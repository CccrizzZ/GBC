...
bool Game::Init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow("Milestone3", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, Camera::width, Camera::height, SDL_WINDOW_SHOWN);
		if (gWindow == NULL)
		{
...
void Game::InitializeModules()
{
	...
	aManager -> SetMusicVolume(15);
	aManager -> LoadSound("Assets/pew.wav");
